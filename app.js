...
const ASESOR_NOMBRE = "Jacqueline";
...
/* Nota: se removió el registro del service worker (PWA) porque
   causaba que los navegadores guardaran versiones viejas del sitio
   y no mostraran las actualizaciones. El archivo service-worker.js
   que sigue en el proyecto ahora solo sirve para "desinstalar" la
   versión vieja en los navegadores que ya la tenían guardada. */
